...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/unionfind.unionfind.test.cpp\"\n#define PROBLEM\
  ...
  verifiedWith: []
documentation_of: test/yosupo/unionfind.unionfind.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/unionfind.unionfind.test.cpp
- /verify/test/yosupo/unionfind.unionfind.test.cpp.html
