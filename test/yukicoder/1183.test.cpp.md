...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1183
    links:
    - https://yukicoder.me/problems/no/1183
  bundledCode: "#line 1 \"test/yukicoder/1183.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1183\"\
    ...
    */\n\ntemplate <typename Container>\nauto groupby(const Container &vec) {\n  \
    ...
    \ 1));\n        else\n            ++(ret[piv].second);\n    }\n    return ret;\n\
    }\n#line 5 \"test/yukicoder/1183.test.cpp\"\n\nsigned main() {\n\n    int N;\n\
    \    cin >> N;\n    vector<int> A(N), B(N), C(N);\n    for (auto &e : A) cin >>\
    \ e;\n    for (auto &e : B) cin >> e;\n    for (int i = 0; i < N; ++i) C[i] =\
    \ A[i] == B[i];\n\n    int res = 0;\n    for (auto &[k, v] : groupby(C)) res +=\
    \ k == 0;\n    cout << res << endl;\n    \n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1183\"\n\n#include \"\
    ../../template/main.hpp\"\n#include \"../../util/groupby.hpp\"\n\nsigned main()\
    \ {\n\n    int N;\n    cin >> N;\n    vector<int> A(N), B(N), C(N);\n    for (auto\
    \ &e : A) cin >> e;\n    for (auto &e : B) cin >> e;\n    for (int i = 0; i <\
    \ N; ++i) C[i] = A[i] == B[i];\n\n    int res = 0;\n    for (auto &[k, v] : groupby(C))\
    \ res += k == 0;\n    cout << res << endl;\n    \n}\n"
  dependsOn:
  - template/main.hpp
  - util/groupby.hpp
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1183.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1183.test.cpp
- /verify/test/yukicoder/1183.test.cpp.html
