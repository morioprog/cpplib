...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/203.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/203\"\
    ...
    */\n\ntemplate <typename Container>\nauto groupby(const Container &vec) {\n  \
    ...
    \ << endl;\n    \n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/203\"\n\n#include \"../../template/main.hpp\"\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/203.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/203.test.cpp
- /verify/test/yukicoder/203.test.cpp.html
